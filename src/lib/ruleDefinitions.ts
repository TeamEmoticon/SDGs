...
export const RULES: readonly RuleDef[] = [
  ...
  { id: "impersonate-agency", category: "impersonation", severity: "high", label: "공공기관·금융기관 사칭", detail: "국세청·금융감독원·경찰 등을 사칭해 신뢰를 얻으려 합니다. 의심되면 공식 홈페이지나 1332로 직접 확인하세요.", keywords: ["국세청", "세무서", "금융감독원", "금감원", "경찰서", "경찰청", "대법원", "법원행정", "정부", "행정안전부", "건강보험"] },
  { id: "coercion-warrant", category: "coercion", severity: "critical", label: "영장·체포로 협박", detail: "체포영장·구속영장·출석요구서를 들먹이며 겁을 줍니다. 수사기관의 안내는 문자 링크가 아닌 공식 절차로만 이루어집니다.", keywords: ["영장", "체포영장", "구속영장", "출석요구서", "출석 요구", "구속", "체포", "전과", "형사고소", "고발"] },
  ...
  { id: "reward-refund", category: "reward", severity: "medium", label: "환급·혜택 미끼", detail: "환급금·적립금·혜택이 있다며 링크를 누르게 합니다. 금융기관 환급은 문자 링크가 아닌 공식 앱/창구에서만 진행됩니다.", keywords: ["환급", "환급금", "수령하세요", "수령하", "적립금", "혜택", "무료 수신", "무료거부"] },
  ...
  { id: "link-install", category: "link", severity: "high", label: "앱 설치·다운로드 유도", detail: "문자로 앱을 설치하라고 하면 사기 앱일 수 있습니다. 앱은 공식 스토어에서만 설치하세요.", keywords: ["앱 설치", "어플 설치", "다운로드", "설치해", "설치하세요", "설치하고", "설치할", "구글플레이", "플레이스토어", "APK", "보안 앱 설치", "원격지원"] },
  ...
  { id: "urgency-pressure", category: "urgency", severity: "medium", label: "조급함 유발", detail: "지금·즉시·오늘 안에 하라며 생각할 틈을 주지 않습니다. 시간에 쫓기게 만드는 글은 한 번 의심하세요.", keywords: ["지금 즉시", "지금 바로", "즉시", "오늘 안", "내일까지", "시간 안에", "마감", "급합니다", "지연 시", "24시간"] },
];
