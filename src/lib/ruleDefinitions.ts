...
export const RULES: readonly RuleDef[] = [
  ...
  { id: "urgency-pressure", category: "urgency", severity: "medium", label: "조급함 유발", detail: "지금·즉시·오늘 안에 하라며 생각할 틈을 주지 않습니다. 시간에 쫓기게 만드는 글은 한 번 의심하세요.", keywords: ["지금 즉시", "지금 바로", "즉시", "오늘 안", "오늘 중", "내일까지", "시간 안에", "급합니다", "지연 시", "24시간"], regex: [/(?:오늘|지금|즉시|긴급).{0,12}마감|마감.{0,12}(?:오늘|지금|즉시|긴급)/] },
];
