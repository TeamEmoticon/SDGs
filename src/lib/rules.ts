...
export const RULES: RuleDef[] = [
  ...
  // ---- Money demands ------------------------------------------------------
  {
    ...
    keywords: [
      "송금", "계좌이체", "이체해", "이체하", "입금해", "입금하", "돈을 보내", "송금해", "보내주세요", "입금 부탁",
      "보내줘", "보내줄", "보내줄 수", "보내달라", "부쳐줘", "부쳐줄", "송금 좀", "이체 좀", "입금 좀",
    ],
  },
  {
    id: "money-virtual",
  ...
  {
    id: "money-account-request",
    category: "money",
    severity: "medium",
    label: "계좌번호 요청",
    detail: "뚜렷한 설명 없이 계좌번호를 요청하는 것은 주의가 필요합니다. 용도를 정확히 확인하세요.",
    keywords: ["계좌번호", "계좌 번호", "이 계좌로", "계좌 좀"],
  },
  ...
  // ---- Personal information harvesting ------------------------------------
  {
    ...
    severity: "critical",
    label: "비밀번호·인증정보 요구",
    detail: "비밀번호·인증번호·OTP·보안카드·공동인증서는 누구도 물어보지 않습니다. 묻는 순간 사기입니다.",
    keywords: [
      "비밀번호", "보안카드", "OTP", "ARS 비밀번호", "공동인증서", "금융인증서", "간편인증", "인증서", "비밀번호 입력",
      "인증번호", "인증 번호",
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: [
      "앱 설치", "어플 설치", "다운로드", "설치해", "설치하세요", "설치하고", "설치할",
      "구글플레이", "플레이스토어", "APK", "보안 앱 설치", "원격지원",
    ],
  },
  ...
  // ---- Remote control takeover --------------------------------------------
  {
    ...
    severity: "critical",
    label: "원격제어·화면공유 요구",
    detail: "원격제어·화면공유 앱을 설치시킨 뒤 내 컴퓨터·계좌를 직접 조종하는 수법입니다. 절대 응하지 말고 전화를 끊으세요.",
    keywords: [
      "원격제어", "원격 제어", "화면공유", "화면 공유", "원격조종", "원격 조종",
      "팀뷰어", "teamviewer", "애니데스크", "anydesk", "퀵서포트", "quicksupport",
    ],
  },
